...
const AboutCards = () => {
  return (
    <div className="about-section w-full min-h-[calc(100vh-5rem)] flex flex-col p-5 justify-center bg-[var(--primary-white)] text-[var(--primary-blue)]">
        <div className="about-title text-center text-xs uppercase">About Us</div>
